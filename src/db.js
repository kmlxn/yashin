export const exercises = [
  {
    ...
    tests: [
      ...
      { input: 'Barakalla', output: 'Barakalla' },
      {
        input: 'Taqvim, uchar, ohangrabo, unsur, riyoziyot.',
        output: 'Taqvim, uchar, ohangrabo, unsur, riyoziyot.'
      }
    ],
    example: {
...
print(kiritilgan_malumot)`
  ...
  },
  {
    ...
    text:
      "<i>Asosiy</i>. Foydalanuvchidan oylik maoshini so'rang. Yiliga topadigan pulini hisoblab bering.",
    tests: [
...
print(kiritilgan_malumot * 12)`
  ...
  },
  {
    ...
    text:
      "<i>Asosiy</i>. Foydalanuvchidan oylik maoshini so'rang. Yiliga topadigan pulini hisoblab bering. 25% soliqni inobatga oling.",
    tests: [
...
print(kiritilgan_malumot * 12 * 0.75)`
  ...
  },
  {
    ...
    text:
      "<i>Asosiy</i>. Foydalanuvchidan oylik maoshini so'rang. Foydalanuvchi 90% oylik maoshini sarflaydi. Yiliga saqlab qoladigan pulini hisoblab bering.",
    tests: [
...
print(kiritilgan_malumot * 12 * 0.1)`
  ...
  {
    id: '6b791c6a-f93b-446f-428e-c07fee49ad58',
    text:
      "<i>Asosiy</i>. Dollarni so'mga aylantiradigan dasturni tuzing. Kurs 9500.",
    tests: [
      { input: '1', output: '9500' },
      { input: '10', output: '95000' },
      { input: '234', output: '2223000' }
    ],
    example: {
      24: `kiritilgan_malumot = input()
print(kiritilgan_malumot * 12 * 0.1)`
  ...
  },
  {
    id: '6b791c6a-f93b-446f-428e-c07fee49ad58',
    text:
      "<i>Asosiy</i>. So'mni dollarga aylantiradigan dasturni tuzing. Kurs 9500. Javobni yaxlitlang.",
    tests: [
      { input: '9500', output: '1' },
      { input: '95000', output: '10' },
      { input: '2223000', output: '234' }
    ],
    example: {
      24: `kiritilgan_malumot = input()
print(kiritilgan_malumot * 12 * 0.1)`
  ...
  },
  {
    ...
    text:
      "<i>Asosiy</i>. Foydalanuvchidan oylik maoshini so'rang. Foydalanuvchi 90% oylik maoshini sarflaydi. Yiliga saqlab qoladigan pulini hisoblab bering. 25% soliqni inobatga oling.",
    tests: [
...
so'm
    ...
    tests: [
      {
        input: 'Kamollidin',
        output:
          'Assalomu alaykum xurmatli Kamollidin! Sizni mehmonga taklif kilyapmiz. Kamollidin, sizni kutamiz.'
      },
      {
        input: 'Akmal',
        output:
          'Assalomu alaykum xurmatli Akmal! Sizni mehmonga taklif kilyapmiz. Akmal, sizni kutamiz.'
      }
    ],
    example: {}
  },
  ...
  },
  {
    ...
    tests: [
      {
        input: '',
        output: '12 15 18 21 24 27 30 33 36 39 42 45 48 51 54 57 60'
      }
    ],
    example: {}
  },
  ...
  },
  {
    ...
    tests: [
      {
        input: '',
        output: '13.5 16.0 18.5 21.0 23.5 26.0 28.5 31.0 33.5 36.0 38.5 41.0'
      }
    ],
    example: {}
  },
  ...
  },
  {
    ...
    tests: [
      {
        input: '',
        output: '10 11 9 12 8 13 7 14 6 15 5 16 4 17 3 18 2 19 1 20 0'
      }
    ],
    example: {}
  },
  {
    ...
    tests: [
      {
        input: '',
        output: '48271088561613960642858365853327381832862269440000000'
      }
    ],
    example: {}
  },
...
stdin.addListener("data", function(kiritilgan_malumot) { 
  ...
  },
  {
    ...
    text:
      "<i>Ro'yxatlar</i>. Berilgan 10 sonlarni ichida eng kattasini toping.",
    tests: [
...
export const editorLanguages = [
  {
    languageId: 24,
    mode: { name: 'python', mime: 'text/x-python', version: 3 },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/python/python.min.js'
  },
  {
    languageId: 5,
    mode: { mime: 'text/x-python', version: 2 },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/python/python.min.js'
  },
  {
    languageId: 8,
    mode: { mime: 'application/x-httpd-php' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/php/php.min.js'
  },
  {
    languageId: 1,
    mode: { mime: 'text/x-csharp' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/clike/clike.min.js'
  },
  {
    languageId: 4,
    mode: { mime: 'text/x-java' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/clike/clike.min.js'
  },
  {
    languageId: 6,
    mode: { mime: 'text/x-csrc' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/clike/clike.min.js'
  },
  {
    languageId: 7,
    mode: { mime: 'text/x-c++src' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/clike/clike.min.js'
  },
  {
    languageId: 10,
    mode: { mime: 'text/x-objectivec' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/clike/clike.min.js'
  },
  {
    languageId: 21,
    mode: { mime: 'text/x-scala' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/clike/clike.min.js'
  },
  {
    languageId: 43,
    mode: { mime: 'text/x-kotlin' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/clike/clike.min.js'
  },
  {
    languageId: 23,
    mode: { mime: 'text/javascript' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/javascript/javascript.min.js'
  },
  {
    languageId: 20,
    mode: { mime: 'text/x-go' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/go/go.min.js'
  },
  {
    languageId: 37,
    mode: { mime: 'text/x-swift' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/swift/swift.min.js'
  },
  {
    languageId: 12,
    mode: { mime: 'text/x-ruby' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/ruby/ruby.min.js'
  },
  {
    languageId: 9,
    mode: { mime: 'text/x-pascal' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/pascal/pascal.min.js'
  },
  {
    languageId: 11,
    mode: { mime: 'text/x-haskell' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/haskell/haskell.min.js'
  },
  {
    languageId: 18,
    mode: { mime: 'text/x-common-lisp' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/commonlisp/commonlisp.min.js'
  },
  {
    languageId: 25,
    mode: { mime: 'text/x-octave' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/octave/octave.min.js'
  },
  {
    languageId: 38,
    mode: { mime: 'text/x-sh' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/shell/shell.min.js'
  },
  {
    languageId: 40,
    mode: { mime: 'text/x-erlang' },
    url:
      'https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.34.0/mode/erlang/erlang.min.js'
  }
]

export const themes = ['solarized light', 'darcula']
